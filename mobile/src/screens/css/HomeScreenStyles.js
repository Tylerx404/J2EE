...
export const styles = StyleSheet.create({
    ...
    walletPickerRow: { marginBottom: 14, zIndex: 10 },
    walletDropdown: {
        flexDirection: 'row',
        alignItems: 'center',
    ...
    walletDropdownLabel: { color: COLORS.textMain, fontSize: 14, fontWeight: '600' },
    walletDropdownMenu: {
        marginTop: 10,
        borderRadius: 14,
        backgroundColor: '#fff',
    ...
    walletDropdownItemActive: { backgroundColor: '#EEF2FF' },
    walletDropdownItemText: { color: COLORS.textMain, fontSize: 14 },
    walletDropdownItemTextActive: { color: COLORS.primary, fontWeight: '700' },
